...
@RestController @RequestMapping("/api") @RequiredArgsConstructor public class CampController {
 ...
 @DeleteMapping("/campers/{id}") @ResponseStatus(HttpStatus.NO_CONTENT) void deleteCamper(@PathVariable UUID id){service.deleteCamper(id);}
 @DeleteMapping("/campers") @ResponseStatus(HttpStatus.NO_CONTENT) void deleteCampers(@Valid @RequestBody CamperIdsRequest request){service.deleteCampers(request.camperIds());}

...
public final class ApiModels { private ApiModels(){}
 ...
 public record CaringLeaderRequest(@NotBlank @Size(max=180) String name,@NotNull Domain.Gender gender){}
 public record GenerateCaringRequest(@NotEmpty List<@Valid CaringLeaderRequest> leaders){}
 public record CaringLeaderUpdateRequest(@NotBlank @Size(max=180) String name){}
 ...
 public record CaringGroupView(UUID id,String name,String leaderName,Domain.Gender gender,long occupancy,double averageAge,List<CamperView> campers){}
 ...
 public record Dashboard(Object camp,List<RoomView> rooms,List<GroupView> groups,List<CaringGroupView> caringGroups,List<CamperView> campers,Stats stats){}

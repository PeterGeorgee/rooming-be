...
@Service @RequiredArgsConstructor public class AccessService {
 private final AuthContext auth; private final CampMembershipRepository memberships; private final RoomRepository rooms; private final DiscussionGroupRepository groups; private final CamperRepository campers; private final PreferenceRepository preferences;
